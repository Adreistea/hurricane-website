<template>
        ...
        <div class="lg:w-1/2 lg:pr-12 mb-10 lg:mb-0 slide-in-left">
          <div class="text-reveal mb-6">
            <h1 class="text-reveal-content text-5xl lg:text-6xl font-bold leading-tight delay-200"
                style="color: #973131;">
              Peer-to-Peer Lending Payment Solutions
            </h1>
          </div>
          ...
          <div class="text-reveal mb-8">
            <h2 class="text-reveal-content text-2xl lg:text-3xl font-semibold leading-tight delay-200 text-gray-800">
              P2P Lending Merchant Account: Essential Payment Solutions for Modern Lending Platforms
            </h2>
          </div>
          
          <div class="text-reveal mb-8">
            <p class="text-reveal-content text-lg text-gray-600 delay-300">
              As a peer-to-peer lending platform, you need a reliable payment processing solution that can handle the complexities of online lending transactions. Our high-risk merchant accounts are specifically designed to support P2P lending businesses, ensuring smooth operations and secure payment processing for both lenders and borrowers.
            </p>
            ...
            <ul class="mt-4 space-y-2">
              <li class="flex items-start fade-in-slide-up" style="animation-delay: 100ms;">
                ...
                <span class="ml-3 text-gray-700">Specialized P2P Lending Solutions</span>
              </li>
              <li class="flex items-start fade-in-slide-up" style="animation-delay: 200ms;">
                ...
                <span class="ml-3 text-gray-700">Secure Transaction Processing</span>
              </li>
              <li class="flex items-start fade-in-slide-up" style="animation-delay: 300ms;">
                ...
                <span class="ml-3 text-gray-700">Automated Payment Systems</span>
              </li>
              <li class="flex items-start fade-in-slide-up" style="animation-delay: 400ms;">
                ...
                <span class="ml-3 text-gray-700">Risk Management Tools</span>
              </li>
              <li class="flex items-start fade-in-slide-up" style="animation-delay: 500ms;">
                ...
                <span class="ml-3 text-gray-700">Multiple Banking Partners</span>
              </li>
              <li class="flex items-start fade-in-slide-up" style="animation-delay: 600ms;">
                ...
                <span class="ml-3 text-gray-700">Fraud Prevention Systems</span>
              </li>
            </ul>
          </div>
    ...
    <div class="rounded-lg shadow-2xl overflow-hidden">
      ...
      <div class="container mx-auto px-6 py-20 mt-8">
        ...
        <div class="text-center mb-16 scroll-reveal opacity-0">
          <span class="inline-block text-indigo-600 font-semibold mb-4 tracking-wider text-sm uppercase scroll-reveal opacity-0" style="animation-delay: 0.2s; color: #973131;">
            Get Started with P2P Lending Payment Processing
          </span>
          <h2 class="text-4xl lg:text-5xl font-bold mb-6 scroll-reveal opacity-0" style="animation-delay: 0.4s;">
            Set Up Your P2P Lending Merchant Account in Four Easy Steps
          </h2>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div class="bg-white rounded-lg p-8 text-center shadow-lg scroll-reveal opacity-0 stats-card" data-delay="0">
            ...
            <p class="text-gray-700">
              Begin with our straightforward online application designed for P2P lending platforms.
            </p>
          </div>
          ...
          <div class="bg-white rounded-lg p-8 text-center shadow-lg scroll-reveal opacity-0 stats-card" data-delay="200">
            ...
            <p class="text-gray-700">
              Provide necessary compliance and business documentation for your P2P lending platform.
            </p>
          </div>
          ...
          <div class="bg-white rounded-lg p-8 text-center shadow-lg scroll-reveal opacity-0 stats-card" data-delay="400">
            ...
            <p class="text-gray-700">
              Our experts evaluate your platform and ensure compliance with lending regulations.
            </p>
          </div>
          ...
          <div class="bg-white rounded-lg p-8 text-center shadow-lg scroll-reveal opacity-0 stats-card" data-delay="600">
            ...
            <h3 class="text-xl font-bold mb-3 text-gray-800">Start Processing</h3>
            <p class="text-gray-700">
              Begin processing loans, repayments, and other P2P lending transactions with Hurricane Payments' secure payment processing solutions.
            </p>
          </div>
        </div>
      </div>
          ...
          <div class="max-w-7xl mx-auto">
            ...
            <div class="text-center mb-16">
              ...
              <h2 class="text-4xl lg:text-5xl font-bold mb-6" style="color: #973131;">
                Understanding High-Risk Designation for P2P Lending Platforms
              </h2>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
              ...
              <div class="relative order-2 lg:order-1">
                <div class="relative z-10 rounded-xl overflow-hidden shadow-2xl transition duration-500 transform hover:scale-[1.02]">
                  <img :src="thirdImage" alt="P2P Lending High-Risk Merchant Services" class="w-full h-[800px] object-cover" />
                  <div class="absolute inset-0 bg-gradient-to-t from-gray-900/70 to-transparent"></div>
                  <div class="absolute bottom-0 left-0 w-full p-8">
                    <div class="bg-white/10 backdrop-blur-sm p-6 rounded-lg border border-white/20">
                      <h3 class="text-xl font-bold mb-2 text-white">Expert Solutions for P2P Lending</h3>
                      <p class="text-white/90">Specialized processing for peer-to-peer lending platforms</p>
                    </div>
                  </div>
                </div>
              ...
              <div class="order-1 lg:order-2">
                <div class="space-y-8">
                  <div class="bg-white rounded-xl p-8 shadow-xl transform transition hover:shadow-2xl duration-500 border-l-4 border-custom-red">
                    <h3 class="text-2xl font-bold mb-4" style="color: #973131;">P2P lending platforms require specialized payment processors</h3>
                    <p class="text-gray-700 leading-relaxed">
                      Trust Hurricane Payments for reliable, secure, and compliant payment processing solutions tailored for the P2P lending industry.
                    </p>
                  </div>
                  ...
                  <div class="bg-gradient-to-r from-gray-900 to-gray-800 rounded-xl p-8 shadow-xl text-white relative overflow-hidden">
                    ...
                    <div class="relative z-10">
                      <h3 class="text-2xl font-bold mb-4 text-white">Choosing the Right P2P Lending Payment Processor</h3>
                      <p class="text-gray-300 leading-relaxed mb-6">
                        Select a payment processor that understands the unique challenges of P2P lending to ensure smooth operations and regulatory compliance. Trust Hurricane Payments for stability and growth.
                      </p>
            ...
            <div class="bg-white rounded-2xl border-2 border-red-100 p-10">
              ...
              <div class="grid grid-cols-1 md:grid-cols-3 gap-10">
                ...
                <div>
                  ...
                  <h3 class="text-xl font-bold mb-4 text-center">P2P Lending Payment Processing</h3>
                  <ul class="ml-5 space-y-2">
                    <li class="flex items-start">
                      <span class="text-custom-red mr-2">•</span>
                      <span class="text-gray-700">Multiple Banking Partnerships</span>
                    </li>
                    <li class="flex items-start">
                      <span class="text-custom-red mr-2">•</span>
                      <span class="text-gray-700">High-Risk Account Solutions</span>
                    </li>
                    <li class="flex items-start">
                      <span class="text-custom-red mr-2">•</span>
                    ...
                    <li class="flex items-start">
                      <span class="text-custom-red mr-2">•</span>
                      <span class="text-gray-700">Online & Mobile Lending Support</span>
                    </li>
                    <li class="flex items-start">
                      <span class="text-custom-red mr-2">•</span>
                      <span class="text-gray-700">Cross-Border Transaction Support</span>
                    </li>
                  </ul>
                </div>
                ...
                <div>
                  ...
                  <h3 class="text-xl font-bold mb-4 text-center">Security & Compliance</h3>
                  <ul class="ml-10 space-y-2">
                    ...
                    <li class="flex items-start">
                      <span class="text-custom-red mr-2">•</span>
                      <span class="text-gray-700">KYC/AML Compliance</span>
                    </li>
                    <li class="flex items-start">
                      <span class="text-custom-red mr-2">•</span>
                    ...
                    <li class="flex items-start">
                      <span class="text-custom-red mr-2">•</span>
                      <span class="text-gray-700">Risk Assessment Tools</span>
                    </li>
                    <li class="flex items-start">
                      <span class="text-custom-red mr-2">•</span>
                ...
                <div>
                  ...
                  <h3 class="text-xl font-bold mb-4 text-center">Platform Integration</h3>
                  <ul class="ml-15 space-y-2">
                    ...
                    <li class="flex items-start">
                      <span class="text-custom-red mr-2">•</span>
                      <span class="text-gray-700">Payment Gateway Solutions</span>
                    </li>
                    <li class="flex items-start">
                      <span class="text-custom-red mr-2">•</span>
                      <span class="text-gray-700">Automated Lending Tools</span>
                    </li>
                    <li class="flex items-start">
                      <span class="text-custom-red mr-2">•</span>
                      <span class="text-gray-700">Developer Documentation</span>
                    </li>
                    <li class="flex items-start">
                      <span class="text-custom-red mr-2">•</span>
                      <span class="text-gray-700">Custom Integration Support</span>
                    </li>
                    <li class="flex items-start">
                      <span class="text-custom-red mr-2">•</span>
                      <span class="text-gray-700">Platform Scalability</span>
                    </li>
                  </ul>
                </div>
              </div>
      ...
      <!-- P2P Lending Payment Gateway Section -->
      <div id="payment-gateway" class="bg-gradient-to-r from-gray-50 to-red-50 py-16">
        <div class="max-w-7xl mx-auto px-4">
          <h2 class="text-4xl font-bold text-center mb-10" style="color: #973131;">Seamless Payment Processing for P2P Lending Platforms</h2>
            ...
            <div class="flex flex-col md:flex-row items-start gap-12">
              <div class="md:w-1/2 relative z-10 self-center">
                <p class="text-lg text-gray-700 leading-relaxed">
                  Our merchant accounts are tailored for P2P lending platforms, providing secure and efficient payment processing solutions. Focus on growing your lending business while we handle the complexities of payment processing.
                </p>
                
                <div class="mt-8 p-6 bg-gradient-to-r from-gray-900 to-gray-800 rounded-lg shadow-lg text-white relative overflow-hidden">
                  <div class="relative z-10">
                    <h3 class="text-2xl font-bold mb-4 text-white">Reliable Payment Solutions for P2P Lending</h3>
                    <p class="text-gray-300 leading-relaxed">
                      Our specialized merchant accounts offer secure, compliant, and efficient payment processing tailored to the unique needs of peer-to-peer lending platforms. With Hurricane Payments' solutions, you can focus on connecting lenders and borrowers while we manage the complexities of payment processing.
                    </p>
                  </div>
                </div>
              </div>
      ...
      <!-- CTA Section -->
      <CtaSection subheading="Apply for your P2P Lending merchant account today and experience hassle-free payment processing." />
    </MainLayout>
  </template>
  ...
  // Import images 
  import firstImage from '@/../images/investmentadvice(2).jpg';
  import secondImage from '@/../images/insurance(4).jpg';
  import thirdImage from '@/../images/moneytransfer(2).jpg';
  import fourthImage from '@/../images/moneytransfer(2).jpg';
