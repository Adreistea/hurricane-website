                ...
                <div class="mt-8 p-6 bg-gradient-to-r from-gray-900 to-gray-800 rounded-lg shadow-lg text-white relative overflow-hidden">
                  ...
                  <div class="relative z-10">
                    ...
                    <p class="text-gray-300 leading-relaxed">
                        At Hurricane Payments, we set high-risk businesses up with high-risk merchant accounts, payment processing, and secure payment gateways. With PayKings, you can get a merchant account with bad credit. We'll work with you to find a merchant account tailored to the specific needs of your business.
                    </p>
                  </div>
                </div>
              </div>
