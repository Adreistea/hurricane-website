<template>
        ...
        <div class="lg:w-1/2 lg:pr-12 mb-10 lg:mb-0 slide-in-left">
          ...
          <div class="text-reveal mb-8">
            <h2 class="text-reveal-content text-2xl lg:text-3xl font-semibold leading-tight delay-200 text-gray-800">
                How do you know if your document preparation business has been categorized as a high-risk merchant?
            </h2>
          </div>
          
          <div class="text-reveal mb-8">
            <p class="text-reveal-content text-lg text-gray-600 delay-300">
                A high-risk merchant account is essential for document preparation businesses. These specialized payment processing accounts are designed for merchants classified in high-risk categories, providing the necessary solutions for online credit card processing in the document preparation industry.
            </p>
    ...
    <div class="rounded-lg shadow-2xl overflow-hidden">
      ...
      <div class="container mx-auto px-6 py-20 mt-8">
        ...
        <div class="text-center mb-16 scroll-reveal opacity-0">
          <span class="inline-block text-indigo-600 font-semibold mb-4 tracking-wider text-sm uppercase scroll-reveal opacity-0" style="animation-delay: 0.2s; color: #973131;">
            Get Started with Document Preparation Payment Processing
          </span>
          <h2 class="text-4xl lg:text-5xl font-bold mb-6 scroll-reveal opacity-0" style="animation-delay: 0.4s;">
            Follow these simple steps to set up your document preparation merchant account
          </h2>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div class="bg-white rounded-lg p-8 text-center shadow-lg scroll-reveal opacity-0 stats-card" data-delay="0">
            ...
            <p class="text-gray-700">
              Start your journey with a simple online application process for your document preparation business.
            </p>
          </div>
          ...
          <div class="bg-white rounded-lg p-8 text-center shadow-lg scroll-reveal opacity-0 stats-card" data-delay="200">
            ...
            <p class="text-gray-700">
              Provide the required documents to support your document preparation merchant account application.
            </p>
          </div>
          ...
          <div class="bg-white rounded-lg p-8 text-center shadow-lg scroll-reveal opacity-0 stats-card" data-delay="400">
            ...
            <p class="text-gray-700">
                Our expert team will guide you through the underwriting process for document preparation businesses.
            </p>
          </div>
          ...
          <div class="bg-white rounded-lg p-8 text-center shadow-lg scroll-reveal opacity-0 stats-card" data-delay="600">
            ...
            <p class="text-gray-700">
                Begin accepting payments for your document preparation services and watch your business thrive.
            </p>
          </div>
        </div>
      </div>
          ...
          <div class="max-w-7xl mx-auto">
            ...
            <div class="text-center mb-16">
              ...
              <h2 class="text-4xl lg:text-5xl font-bold mb-6" style="color: #973131;">
                Understanding High-Risk Designation for Document Preparation Merchant Accounts
              </h2>
                ...
                <div class="space-y-8">
                  ...
                  <div class="bg-gradient-to-r from-gray-900 to-gray-800 rounded-xl p-8 shadow-xl text-white relative overflow-hidden">
                    ...
                    <div class="relative z-10">
                      <h3 class="text-2xl font-bold mb-4 text-white">Choosing the Best Document Preparation Payment Processor for Your Business</h3>
                      <p class="text-gray-300 leading-relaxed mb-6">
                        Securing the right document preparation payment processor is crucial for businesses in the document preparation industry to avoid account closures and fund holds. Learn how Hurricane Payments can provide the stable, high-risk processing account your business needs for uninterrupted sales and growth.
                      </p>
            ...
            <div class="bg-white rounded-2xl border-2 border-red-100 p-10">
              ...
              <div class="grid grid-cols-1 md:grid-cols-3 gap-10">
                ...
                <div>
                  ...
                  <h3 class="text-xl font-bold mb-4 text-center">Document Preparation Merchant Accounts</h3>
                  <ul class="ml-5 space-y-2">
                    ...
                    <li class="flex items-start">
                      <span class="text-custom-red mr-2">•</span>
                      <span class="text-gray-700">Fast Document Preparation Account Approval</span>
                    </li>
                    <li class="flex items-start">
                      <span class="text-custom-red mr-2">•</span>
                    ...
                    <li class="flex items-start">
                      <span class="text-custom-red mr-2">•</span>
                      <span class="text-gray-700">E-Commerce and Retail Document Preparation</span>
                    </li>
                    <li class="flex items-start">
                      <span class="text-custom-red mr-2">•</span>
                      <span class="text-gray-700">B2B Document Preparation Vendors Supported</span>
                    </li>
                  </ul>
                </div>
      ...
      <div id="payment-gateway" class="bg-gradient-to-r from-gray-50 to-red-50 py-16">
        <div class="max-w-7xl mx-auto px-4">
          <h2 class="text-4xl font-bold text-center mb-10" style="color: #973131;">Seamless Payment Processing for Document Preparation Businesses</h2>
            ...
            <div class="flex flex-col md:flex-row items-start gap-12">
              <div class="md:w-1/2 relative z-10 self-center">
                <p class="text-lg text-gray-700 leading-relaxed">
                    Our document preparation merchant accounts are designed to provide smooth, reliable payment processing for your business. With our tailored solutions, you can focus on growing your document preparation platform while we handle the complexities of payment processing.
                </p>
                ...
                <div class="mt-8 p-6 bg-gradient-to-r from-gray-900 to-gray-800 rounded-lg shadow-lg text-white relative overflow-hidden">
                  ...
                  <div class="relative z-10">
                    <h3 class="text-2xl font-bold mb-4 text-white">Reliable Payment Processing Solutions for Document Preparation Businesses</h3>
                    <p class="text-gray-300 leading-relaxed">
                      Our document preparation merchant accounts offer smooth, dependable payment processing tailored to your business needs. With Hurricane Payments' specialized solutions, you can concentrate on expanding your document preparation platform while we manage the intricacies of secure and compliant payment processing.
                    </p>
                  </div>
                </div>
              </div>
      ...
      <!-- CTA Section -->
      <CtaSection subheading="Apply for your document preparation merchant account today and experience hassle-free payment processing." />
    </MainLayout>
  </template>
  ...
  // Import images 
  import firstImage from '@/../images/documentprep.jpg';
  import secondImage from '@/../images/documentprep(2).jpg';
  import thirdImage from '@/../images/documentprep(3).jpg';
  import fourthImage from '@/../images/documentprep(2).jpg';
