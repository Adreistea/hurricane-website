        ...
        <div class="lg:w-1/2 lg:pr-12 mb-10 lg:mb-0 slide-in-left">
          <div class="text-reveal mb-6">
            <h1 class="text-reveal-content text-5xl lg:text-6xl font-bold leading-tight delay-200"
                style="color: #973131;">
                Credit Card Processing for Coins / Stamps / Collectibles Dealers
            </h1>
          </div>
          ...
          <div class="text-reveal mb-8">
            <h2 class="text-reveal-content text-2xl lg:text-3xl font-semibold leading-tight delay-200 text-gray-800">
                Is your coins and collectibles business considered high-risk?
            </h2>
          </div>
          
          <div class="text-reveal mb-8">
            <p class="text-reveal-content text-lg text-gray-600 delay-300">
                Coins and collectibles businesses face unique challenges in the payment processing world. As a high-risk industry, many traditional banks and payment processors are hesitant to work with coins and collectibles merchants. At Hurricane Payments, we specialize in providing merchant accounts and payment processing services tailored to the specific needs of the coins and collectibles industry, ensuring you can process payments securely and efficiently.
            </p>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div class="bg-white rounded-lg p-8 text-center shadow-lg scroll-reveal opacity-0 stats-card" data-delay="0">
            ...
            <p class="text-gray-700">
                Start your journey with a simple online application process for your coins and collectibles business.
            </p>
          </div>
          ...
          <div class="bg-white rounded-lg p-8 text-center shadow-lg scroll-reveal opacity-0 stats-card" data-delay="200">
            ...
            <p class="text-gray-700">
                Provide the required documents to support your coins and collectibles merchant account application.
            </p>
          </div>
          ...
          <div class="bg-white rounded-lg p-8 text-center shadow-lg scroll-reveal opacity-0 stats-card" data-delay="400">
            ...
            <p class="text-gray-700">
                Our expert team will guide you through the underwriting process for coins and collectibles businesses.
            </p>
          </div>
          ...
          <div class="bg-white rounded-lg p-8 text-center shadow-lg scroll-reveal opacity-0 stats-card" data-delay="600">
            ...
            <p class="text-gray-700">
                Begin accepting payments for your coins and collectibles and watch your business thrive.
            </p>
          </div>
        </div>
      </div>
                ...
                <div class="space-y-8">
                  <div class="bg-white rounded-xl p-8 shadow-xl transform transition hover:shadow-2xl duration-500 border-l-4 border-custom-red">
                    ...
                    <p class="text-gray-700 leading-relaxed">
                        Coins and collectibles businesses face unique challenges in the payment processing world. Coins and collectibles are often valuable, meaning many of the payments they process are considered high-value transactions. These high-ticket transactions also mean that collectibles businesses are at a high likelihood of fraudulent or fake goods, and see excessive chargebacks. These three factors combined mean that coins and collectibles are considered high-risk.
                    </p>
                  </div>
