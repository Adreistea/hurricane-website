<template>
    <MainLayout>
      ...
      <div class="container mx-auto px-6 py-16 flex flex-col lg:flex-row items-center">
        ...
        <div class="lg:w-1/2 lg:pr-12 mb-10 lg:mb-0 slide-in-left">
          ...
          <div class="text-reveal mb-8">
            <h2 class="text-reveal-content text-2xl lg:text-3xl font-semibold leading-tight delay-200 text-gray-800">
              How do you know if your payday lending business has been categorized as a high-risk merchant?
            </h2>
          </div>
          
          <div class="text-reveal mb-8">
            <p class="text-reveal-content text-lg text-gray-600 delay-300">
              Payday lenders face unique challenges in the payment processing world. As a high-risk industry, many traditional banks and payment processors are hesitant to work with payday lending businesses. At Hurricane Payments, we specialize in providing merchant accounts tailored to the specific needs of the payday lending industry, ensuring you can process payments securely and efficiently.
            </p>
            ...
            <ul class="mt-4 space-y-2">
              ...
              <li class="flex items-start fade-in-slide-up" style="animation-delay: 400ms;">
                ...
                <span class="ml-3 text-gray-700">Multiple Payment Solutions</span>
              </li>
        ...
        <div class="lg:w-1/2 relative card-reveal delay-200">
          <div class="rounded-lg shadow-2xl overflow-hidden">
            <img :src="firstImage" alt="Payday Lender Payment Processing" class="w-full h-[800px] object-cover" />
          </div>
      ...
      <div class="container mx-auto px-6 py-20 mt-8">
        ...
        <div class="text-center mb-16 scroll-reveal opacity-0">
          <span class="inline-block text-indigo-600 font-semibold mb-4 tracking-wider text-sm uppercase scroll-reveal opacity-0" style="animation-delay: 0.2s; color: #973131;">
            Get Started with Payday Lender Payment Processing
          </span>
          <h2 class="text-4xl lg:text-5xl font-bold mb-6 scroll-reveal opacity-0" style="animation-delay: 0.4s;">
            Set Up Your Payday Lender Merchant Account in Four Easy Steps
          </h2>
          <p class="text-lg text-gray-600 max-w-3xl mx-auto scroll-reveal opacity-0" style="animation-delay: 0.6s;">
            Follow these simple steps to set up your payday lending merchant account and start processing payments for your business.
          </p>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div class="bg-white rounded-lg p-8 text-center shadow-lg scroll-reveal opacity-0 stats-card" data-delay="0">
            ...
            <p class="text-gray-700">
              Begin with our straightforward online application process tailored for payday lending businesses.
            </p>
          </div>
          ...
          <div class="bg-white rounded-lg p-8 text-center shadow-lg scroll-reveal opacity-0 stats-card" data-delay="200">
            ...
            <h3 class="text-xl font-bold mb-3 text-gray-800">Submit Required Documentation</h3>
            <p class="text-gray-700">
              Provide necessary licensing and documentation to support your payday lending merchant account application.
            </p>
          </div>
          ...
          <div class="bg-white rounded-lg p-8 text-center shadow-lg scroll-reveal opacity-0 stats-card" data-delay="400">
            ...
            <h3 class="text-xl font-bold mb-3 text-gray-800">Underwriting Review</h3>
            <p class="text-gray-700">
              Our expert team guides you through the underwriting process specific to payday lending businesses.
            </p>
          </div>
          ...
          <div class="bg-white rounded-lg p-8 text-center shadow-lg scroll-reveal opacity-0 stats-card" data-delay="600">
            ...
            <p class="text-gray-700">
              Begin accepting payments for your payday lending services with our secure and reliable payment processing solutions.
            </p>
          </div>
        </div>
      </div>
          ...
          <div class="max-w-7xl mx-auto">
            ...
            <div class="text-center mb-16">
              ...
              <h2 class="text-4xl lg:text-5xl font-bold mb-6" style="color: #973131;">
                Why are payday lenders categorized as high-risk merchants?
              </h2>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
              ...
              <div class="relative order-2 lg:order-1">
                <div class="relative z-10 rounded-xl overflow-hidden shadow-2xl transition duration-500 transform hover:scale-[1.02]">
                  <img :src="thirdImage" alt="Payday Lender High-Risk Merchant Services" class="w-full h-[800px] object-cover" />
                  ...
                  <div class="absolute bottom-0 left-0 w-full p-8">
                    <div class="bg-white/10 backdrop-blur-sm p-6 rounded-lg border border-white/20">
                      ...
                      <p class="text-white/90">Specialized processing for payday lending businesses</p>
                    </div>
                  </div>
                </div>
                ...
                <div class="space-y-8">
                  <div class="bg-white rounded-xl p-8 shadow-xl transform transition hover:shadow-2xl duration-500 border-l-4 border-custom-red">
                    ...
                    <p class="text-gray-700 leading-relaxed">
                      Payday lenders face unique challenges in the payment processing world. Traditional banks and payment processors often consider payday lending businesses high-risk due to the nature of their operations and regulatory requirements. At Hurricane Payments, we understand these challenges and provide specialized solutions.
                    </p>
                  </div>
                  ...
                  <div class="bg-gradient-to-r from-gray-900 to-gray-800 rounded-xl p-8 shadow-xl text-white relative overflow-hidden">
                    ...
                    <div class="relative z-10">
                      <h3 class="text-2xl font-bold mb-4 text-white">Key Factors for High-Risk Designation</h3>
                      <p class="text-gray-300 leading-relaxed mb-6">
                        Payday lending businesses are often designated as high-risk merchants due to several factors including regulatory compliance requirements, higher chargeback rates, and the nature of short-term lending. Understanding these challenges is crucial for maintaining a stable payment processing solution.
                      </p>
            ...
            <div class="bg-white rounded-2xl border-2 border-red-100 p-10">
              ...
              <div class="grid grid-cols-1 md:grid-cols-3 gap-10">
                ...
                <div>
                  ...
                  <h3 class="text-xl font-bold mb-4 text-center">Payday Lender Merchant Accounts</h3>
                  <ul class="ml-5 space-y-2">
                    ...
                    <li class="flex items-start">
                      <span class="text-custom-red mr-2">•</span>
                      <span class="text-gray-700">High-Risk Merchant Accounts</span>
                    </li>
                    <li class="flex items-start">
                      <span class="text-custom-red mr-2">•</span>
                    ...
                    <li class="flex items-start">
                      <span class="text-custom-red mr-2">•</span>
                      <span class="text-gray-700">Online & Retail Processing</span>
                    </li>
                    <li class="flex items-start">
                      <span class="text-custom-red mr-2">•</span>
                      <span class="text-gray-700">Multiple Location Support</span>
                    </li>
                  </ul>
                </div>
                ...
                <div>
                  ...
                  <h3 class="text-xl font-bold mb-4 text-center">Payment Solutions</h3>
                  <ul class="ml-10 space-y-2">
                    ...
                    <li class="flex items-start">
                      <span class="text-custom-red mr-2">•</span>
                      <span class="text-gray-700">Debit Card Processing</span>
                    </li>
                    <li class="flex items-start">
                      <span class="text-custom-red mr-2">•</span>
                    ...
                    <li class="flex items-start">
                      <span class="text-custom-red mr-2">•</span>
                      <span class="text-gray-700">Online Payment Gateway</span>
                    </li>
                    <li class="flex items-start">
                      <span class="text-custom-red mr-2">•</span>
                      <span class="text-gray-700">Virtual Terminal</span>
                    </li>
                    <li class="flex items-start">
                      <span class="text-custom-red mr-2">•</span>
                ...
                <div>
                  ...
                  <h3 class="text-xl font-bold mb-4 text-center">Additional Features</h3>
                  <ul class="ml-15 space-y-2">
                    <li class="flex items-start">
                      <span class="text-custom-red mr-2">•</span>
                      <span class="text-gray-700">Fraud Prevention Tools</span>
                    </li>
                    <li class="flex items-start">
                      <span class="text-custom-red mr-2">•</span>
                      <span class="text-gray-700">Chargeback Protection</span>
                    </li>
                    <li class="flex items-start">
                      <span class="text-custom-red mr-2">•</span>
                      <span class="text-gray-700">Customer Database</span>
                    </li>
                    <li class="flex items-start">
                      <span class="text-custom-red mr-2">•</span>
                      <span class="text-gray-700">Reporting & Analytics</span>
                    </li>
                    <li class="flex items-start">
                      <span class="text-custom-red mr-2">•</span>
                    ...
                    <li class="flex items-start">
                      <span class="text-custom-red mr-2">•</span>
                      <span class="text-gray-700">Compliance Support</span>
                    </li>
                  </ul>
                </div>
              </div>
      ...
      <div id="payment-gateway" class="bg-gradient-to-r from-gray-50 to-red-50 py-16">
        <div class="max-w-7xl mx-auto px-4">
          <h2 class="text-4xl font-bold text-center mb-10" style="color: #973131;">Payday Lender Payment Gateway</h2>
            ...
            <div class="flex flex-col md:flex-row items-start gap-12">
              <div class="md:w-1/2 relative z-10 self-center">
                <p class="text-lg text-gray-700 leading-relaxed">
                  Hurricane Payments' payday lender payment gateway is designed specifically for the unique needs of payday lending businesses. Our platform offers secure, reliable transaction processing with built-in compliance tools, fraud prevention, and comprehensive reporting features. With advanced encryption technology and robust chargeback protection, we ensure both lenders and borrowers are protected throughout every transaction.
                </p>
                ...
                <div class="mt-8 p-6 bg-gradient-to-r from-gray-900 to-gray-800 rounded-lg shadow-lg text-white relative overflow-hidden">
                  ...
                  <div class="relative z-10">
                    <h3 class="text-2xl font-bold mb-4 text-white">Reliable Payment Processing Solutions for Payday Lenders</h3>
                    <p class="text-gray-300 leading-relaxed">
                      Our payday lender merchant accounts offer smooth, dependable payment processing tailored to your business needs. With Hurricane Payments' specialized solutions, you can focus on growing your lending business while we handle the complexities of secure and compliant payment processing.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div class="md:w-1/2">
                <div class="relative">
                  ...
                  <div class="rounded-lg overflow-hidden shadow-lg relative z-20">
                    <img :src="fourthImage" alt="Payday Lender Payment Gateway" class="w-full h-auto transform transition hover:scale-105 duration-500">
                  ...
                  <div class="absolute -bottom-10 -right-10 bg-white rounded-lg shadow-xl p-6 z-30 max-w-xs transform rotate-3">
                    ...
                    <ul class="space-y-2">
                      ...
                      <li class="flex items-center">
                        ...
                        <span class="text-gray-700">Automated Payments</span>
                      </li>
                    </ul>
                  </div>
                </div>
      ...
      <!-- CTA Section -->
      <CtaSection subheading="Apply for your payday lender merchant account today and experience hassle-free payment processing." />
    </MainLayout>
  </template>
  ...
  // Import images 
  import firstImage from '@/../images/paydaylender.jpg';
  import secondImage from '@/../images/paydaylender(2).jpg';
  import thirdImage from '@/../images/paydaylender(3).jpg';
  import fourthImage from '@/../images/paydaylender(4).jpg';
