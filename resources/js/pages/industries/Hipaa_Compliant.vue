<template>
    <MainLayout>
      ...
      <div class="container mx-auto px-6 py-16 flex flex-col lg:flex-row items-center">
        ...
        <div class="lg:w-1/2 lg:pr-12 mb-10 lg:mb-0 slide-in-left">
          ...
          <div class="text-reveal mb-8">
            <h2 class="text-reveal-content text-2xl lg:text-3xl font-semibold leading-tight delay-200 text-gray-800">
              Secure Payment Processing for Healthcare Providers
            </h2>
          </div>
          
          <div class="text-reveal mb-8">
            <p class="text-reveal-content text-lg text-gray-600 delay-300">
              In today's healthcare environment, maintaining HIPAA compliance while processing payments is crucial. Healthcare providers need payment solutions that protect patient information while providing efficient transaction processing. Hurricane Payments offers comprehensive HIPAA-compliant payment processing solutions designed specifically for healthcare providers, ensuring both security and compliance in every transaction.
            </p>
        ...
        <div class="lg:w-1/2 relative card-reveal delay-200">
          <div class="rounded-lg shadow-2xl overflow-hidden">
            <img :src="firstImage" alt="HIPAA Compliant Payment Processing" class="w-full h-[800px] object-cover" />
          </div>
      ...
      <!-- HIPAA Compliant Payment Processing Section -->
      <div class="container mx-auto px-6 py-20 mt-8">
        ...
        <div class="text-center mb-16 scroll-reveal opacity-0">
          ...
          <h2 class="text-4xl lg:text-5xl font-bold mb-6 scroll-reveal opacity-0" style="animation-delay: 0.4s;">
            Get Started with HIPAA Compliant Payment Processing
          </h2>
          <p class="text-lg text-gray-600 max-w-3xl mx-auto scroll-reveal opacity-0" style="animation-delay: 0.6s;">
            Follow these simple steps to implement secure healthcare payment processing
          </p>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div class="bg-white rounded-lg p-8 text-center shadow-lg scroll-reveal opacity-0 stats-card" data-delay="0">
            ...
            <h3 class="text-xl font-bold mb-3 text-gray-800">Complete compliance assessment</h3>
            <p class="text-gray-700">
              Begin with our HIPAA compliance evaluation process for your payment needs.
            </p>
          </div>
          ...
          <div class="bg-white rounded-lg p-8 text-center shadow-lg scroll-reveal opacity-0 stats-card" data-delay="200">
            ...
            <h3 class="text-xl font-bold mb-3 text-gray-800">Implement secure solutions</h3>
            <p class="text-gray-700">
              Set up HIPAA-compliant payment processing systems tailored to your practice.
            </p>
          </div>
          ...
          <div class="bg-white rounded-lg p-8 text-center shadow-lg scroll-reveal opacity-0 stats-card" data-delay="400">
            ...
            <h3 class="text-xl font-bold mb-3 text-gray-800">Receive compliance training</h3>
            <p class="text-gray-700">
              Access comprehensive training on maintaining HIPAA compliance in payment processing.
            </p>
          </div>
          ...
          <div class="bg-white rounded-lg p-8 text-center shadow-lg scroll-reveal opacity-0 stats-card" data-delay="600">
            ...
            <h3 class="text-xl font-bold mb-3 text-gray-800">Start secure processing</h3>
            <p class="text-gray-700">
              Begin accepting payments while maintaining HIPAA compliance and data security.
            </p>
          </div>
        </div>
      </div>
        ...
        <div class="container mx-auto px-6 relative z-10">
          <div class="max-w-7xl mx-auto">
            ...
            <div class="text-center mb-16">
              <span class="inline-block bg-red-50 text-custom-red px-4 py-2 rounded-full font-medium text-sm uppercase tracking-wide mb-4">Understanding HIPAA Compliance</span>
              <h2 class="text-4xl lg:text-5xl font-bold mb-6" style="color: #973131;">
                Why Choose Hurricane Payments for HIPAA Compliant Payment Processing?
              </h2>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
              ...
              <div class="relative order-2 lg:order-1">
                <div class="relative z-10 rounded-xl overflow-hidden shadow-2xl transition duration-500 transform hover:scale-[1.02]">
                  <img :src="thirdImage" alt="HIPAA Compliant Payment Solutions" class="w-full h-[800px] object-cover" />
                  <div class="absolute inset-0 bg-gradient-to-t from-gray-900/70 to-transparent"></div>
                  <div class="absolute bottom-0 left-0 w-full p-8">
                    <div class="bg-white/10 backdrop-blur-sm p-6 rounded-lg border border-white/20">
                      <h3 class="text-xl font-bold mb-2 text-white">Expert Healthcare Payment Solutions</h3>
                      <p class="text-white/90">Specialized processing for healthcare providers</p>
                    </div>
                  </div>
                </div>
              ...
              <div class="order-1 lg:order-2">
                <div class="space-y-8">
                  <div class="bg-white rounded-xl p-8 shadow-xl transform transition hover:shadow-2xl duration-500 border-l-4 border-custom-red">
                    <h3 class="text-2xl font-bold mb-4" style="color: #973131;">Key Components of HIPAA Compliant Payment Processing</h3>
                    <p class="text-gray-700 leading-relaxed">
                      Our HIPAA-compliant payment solutions address critical requirements including data encryption, access controls, audit trails, secure storage, and business associate agreements.
                    </p>
                  </div>
                  ...
                  <div class="bg-gradient-to-r from-gray-900 to-gray-800 rounded-xl p-8 shadow-xl text-white relative overflow-hidden">
                    ...
                    <div class="relative z-10">
                      <h3 class="text-2xl font-bold mb-4 text-white">Understanding HIPAA Compliance in Payment Processing</h3>
                      <p class="text-gray-300 leading-relaxed mb-6">
                        Healthcare payment processing requires specialized solutions that maintain HIPAA compliance while providing efficient transaction processing. You need a payment processor who understands healthcare regulations and can provide comprehensive solutions.
                      </p>
          ...
          <div class="bg-white rounded-2xl border-2 border-red-100 p-10">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-10">
              ...
              <div>
                ...
                <h3 class="text-xl font-bold mb-4 text-center">Healthcare Merchant Accounts</h3>
                <ul class="ml-5 space-y-2">
                  ...
                  <li class="flex items-start">
                    <span class="text-custom-red mr-2">•</span>
                    <span class="text-gray-700">Fast Healthcare Account Approval</span>
                  </li>
                  <li class="flex items-start">
                    <span class="text-custom-red mr-2">•</span>
                  ...
                  <li class="flex items-start">
                    <span class="text-custom-red mr-2">•</span>
                    <span class="text-gray-700">E-Commerce and Retail Healthcare</span>
                  </li>
                  <li class="flex items-start">
                    <span class="text-custom-red mr-2">•</span>
      ...
      <div id="payment-gateway" class="bg-gradient-to-r from-gray-50 to-red-50 py-16">
        <div class="max-w-7xl mx-auto px-4">
          <h2 class="text-4xl font-bold text-center mb-10" style="color: #973131;">HIPAA Compliant Payment Processing Solutions</h2>
            ...
            <div class="flex flex-col md:flex-row items-start gap-12">
              <div class="md:w-1/2 relative z-10 self-center">
                <p class="text-lg text-gray-700 leading-relaxed">
                  Our merchant accounts are designed for secure, HIPAA-compliant payment processing. Focus on providing healthcare while we handle the complexities of secure payment solutions.
                </p>
                ...
                <div class="mt-8 p-6 bg-gradient-to-r from-gray-900 to-gray-800 rounded-lg shadow-lg text-white relative overflow-hidden">
                  ...
                  <div class="relative z-10">
                    <h3 class="text-2xl font-bold mb-4 text-white">Reliable Payment Processing Solutions for Healthcare Providers</h3>
                    <p class="text-gray-300 leading-relaxed">
                      Our HIPAA-compliant merchant accounts offer secure, dependable payment processing tailored to your healthcare business needs. With Hurricane Payments' specialized solutions, you can concentrate on patient care while we manage the intricacies of secure and compliant payment processing.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div class="md:w-1/2">
                <div class="relative">
                  ...
                  <div class="rounded-lg overflow-hidden shadow-lg relative z-20">
                    <img :src="fourthImage" alt="HIPAA Compliant Payment Gateway" class="w-full h-auto transform transition hover:scale-105 duration-500">
                    ...
                    <div class="absolute bottom-0 left-0 p-6">
                      ...
                      <div class="flex items-center">
                        ...
                        <span class="text-white font-medium">HIPAA & PCI DSS Compliant</span>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="absolute -bottom-10 -right-10 bg-white rounded-lg shadow-xl p-6 z-30 max-w-xs transform rotate-3">
                    ...
                    <ul class="space-y-2">
                      ...
                      <li class="flex items-center">
                        ...
                        <span class="text-gray-700">Secure Patient Data</span>
                      </li>
                      <li class="flex items-center">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-green-500 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                          <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7" />
                        </svg>
                        <span class="text-gray-700">Audit Trail</span>
                      </li>
                    </ul>
                  </div>
                </div>
      ...
      <!-- CTA Section -->
      <CtaSection subheading="Apply for your HIPAA-compliant merchant account today and experience secure healthcare payment processing." />
    </MainLayout>
  </template>
  ...
  // Import images 
  import firstImage from '@/../images/hipaa.jpg';
  import secondImage from '@/../images/hipaa(2).jpg';
  import thirdImage from '@/../images/hipaa(3).jpg';
  import fourthImage from '@/../images/hipaa(4).jpg';
