<template>
        ...
        <div class="lg:w-1/2 lg:pr-12 mb-10 lg:mb-0 slide-in-left">
          <div class="text-reveal mb-6">
            <h1 class="text-reveal-content text-5xl lg:text-6xl font-bold leading-tight delay-200"
                style="color: #973131;">
                Automotive Payment Merchant Account
            </h1>
          </div>
          ...
          <div class="text-reveal mb-8">
            <h2 class="text-reveal-content text-2xl lg:text-3xl font-semibold leading-tight delay-200 text-gray-800">
                Is Your Automotive Business Classified as High-Risk?
            </h2>
          </div>
      ...
      <div class="container mx-auto px-6 py-20 mt-8">
        ...
        <div class="text-center mb-16 scroll-reveal opacity-0">
          <span class="inline-block text-indigo-600 font-semibold mb-4 tracking-wider text-sm uppercase scroll-reveal opacity-0" style="animation-delay: 0.2s; color: #973131;">
            Get Started with Automotive Payment Processing
          </span>
          <h2 class="text-4xl lg:text-5xl font-bold mb-6 scroll-reveal opacity-0" style="animation-delay: 0.4s;">
            Set Up Your Automotive Merchant Account in Four Easy Steps
          </h2>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div class="bg-white rounded-lg p-8 text-center shadow-lg scroll-reveal opacity-0 stats-card" data-delay="0">
            ...
            <p class="text-gray-700">
                Begin with our straightforward online application tailored for automotive businesses.
            </p>
          </div>
          ...
          <div class="max-w-7xl mx-auto">
            ...
            <div class="text-center mb-16">
              ...
              <h2 class="text-4xl lg:text-5xl font-bold mb-6" style="color: #973131;">
               Understanding High-Risk Designation for Automotive Merchant Accounts
              </h2>
                ...
                <div class="space-y-8">
                  <div class="bg-white rounded-xl p-8 shadow-xl transform transition hover:shadow-2xl duration-500 border-l-4 border-custom-red">
                    ...
                    <p class="text-gray-700 leading-relaxed">
                        Because they often process high-ticket transactions, automotive shops are usually considered high-risk. High-risk merchants require specialized payment processors. Avoid disruptions with Hurricane Payments, a leader in high-risk merchant account solutions for the automotive industry. We'll tailor payment processing solutions to your business needs so you can save money and offer multiple payment options to your automotive clients.
                    </p>
                  </div>
          ...
          <div class="bg-white rounded-2xl border-2 border-red-100 p-10">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-10">
              ...
              <div>
                ...
                <h3 class="text-xl font-bold mb-4 text-center">Automotive Merchant Accounts</h3>
                <ul class="ml-5 space-y-2">
                  ...
                  <li class="flex items-start">
                    <span class="text-custom-red mr-2">•</span>
                    <span class="text-gray-700">Fast Automotive Account Approval</span>
                  </li>
                  <li class="flex items-start">
                    <span class="text-custom-red mr-2">•</span>
                  ...
                  <li class="flex items-start">
                    <span class="text-custom-red mr-2">•</span>
                    <span class="text-gray-700">E-Commerce and Retail Automotive</span>
                  </li>
                  <li class="flex items-start">
                    <span class="text-custom-red mr-2">•</span>
                    <span class="text-gray-700">B2B Automotive Vendors Supported</span>
                  </li>
                </ul>
              </div>
  ...
  <div class="md:w-1/2 relative z-10 self-center">
    <p class="text-2xl text-gray-700 leading-relaxed">
      Our automotive merchant services are designed for smooth, reliable payment processing. Focus on expanding your platform while we handle the complexities of high-risk payment solutions.
    </p>
  ...
  // Import images 
  import firstImage from '@/../images/automotive.jpg';
  import secondImage from '@/../images/automotive(2).jpg';
  import thirdImage from '@/../images/automotive(2).jpg';
  import fourthImage from '@/../images/automotive(3).jpg';
