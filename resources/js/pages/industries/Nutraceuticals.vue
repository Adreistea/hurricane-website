<template>
    <MainLayout>
      ...
      <div class="container mx-auto px-6 py-16 flex flex-col lg:flex-row items-center">
        ...
        <div class="lg:w-1/2 lg:pr-12 mb-10 lg:mb-0 slide-in-left">
          ...
          <div class="text-reveal mb-8">
            <h2 class="text-reveal-content text-2xl lg:text-3xl font-semibold leading-tight delay-200 text-gray-800">
              Is your nutraceuticals business considered high-risk?
            </h2>
          </div>
          
          <div class="text-reveal mb-8">
            <p class="text-reveal-content text-lg text-gray-600 delay-300">
              A high-risk merchant account is essential for nutraceutical businesses. These specialized payment processing accounts are designed for merchants classified in high-risk categories, providing the necessary solutions for online credit card processing in the nutraceuticals industry. At Hurricane Payments, we specialize in providing nutraceutical merchant accounts and have the expertise to set your supplement or nutraceutical business up with customized payment processing solutions.
            </p>
        ...
        <div class="lg:w-1/2 relative card-reveal delay-200">
          <div class="rounded-lg shadow-2xl overflow-hidden">
            <img :src="firstImage" alt="Nutraceutical Payment Processing" class="w-full h-[800px] object-cover" />
          </div>
      ...
      <!-- Nutraceutical Merchant Accounts Section -->
      <div class="container mx-auto px-6 py-20 mt-8">
        ...
        <div class="text-center mb-16 scroll-reveal opacity-0">
          <span class="inline-block text-indigo-600 font-semibold mb-4 tracking-wider text-sm uppercase scroll-reveal opacity-0" style="animation-delay: 0.2s; color: #973131;">
            Get Started with Nutraceutical Payment Processing
          </span>
          <h2 class="text-4xl lg:text-5xl font-bold mb-6 scroll-reveal opacity-0" style="animation-delay: 0.4s;">
            Set Up Your Nutraceutical Merchant Account in Four Easy Steps
          </h2>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div class="bg-white rounded-lg p-8 text-center shadow-lg scroll-reveal opacity-0 stats-card" data-delay="0">
            ...
            <p class="text-gray-700">
              Start your journey with a simple online application process for your nutraceutical business.
            </p>
          </div>
          ...
          <div class="bg-white rounded-lg p-8 text-center shadow-lg scroll-reveal opacity-0 stats-card" data-delay="200">
            ...
            <p class="text-gray-700">
              Provide the required documents to support your nutraceutical merchant account application.
            </p>
          </div>
          ...
          <div class="bg-white rounded-lg p-8 text-center shadow-lg scroll-reveal opacity-0 stats-card" data-delay="400">
            ...
            <p class="text-gray-700">
              Our expert team will guide you through the underwriting process for nutraceutical businesses.
            </p>
          </div>
          ...
          <div class="bg-white rounded-lg p-8 text-center shadow-lg scroll-reveal opacity-0 stats-card" data-delay="600">
            ...
            <p class="text-gray-700">
              Begin accepting payments for your supplements and nutraceutical products and watch your business thrive.
            </p>
          </div>
        </div>
      </div>
          ...
          <div class="max-w-7xl mx-auto">
            ...
            <div class="text-center mb-16">
              ...
              <h2 class="text-4xl lg:text-5xl font-bold mb-6" style="color: #973131;">
                Why are nutraceutical businesses categorized as high-risk merchants?
              </h2>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
              ...
              <div class="relative order-2 lg:order-1">
                <div class="relative z-10 rounded-xl overflow-hidden shadow-2xl transition duration-500 transform hover:scale-[1.02]">
                  <img :src="thirdImage" alt="Nutraceutical High-Risk Merchant Services" class="w-full h-[800px] object-cover" />
                  ...
                  <div class="absolute bottom-0 left-0 w-full p-8">
                    <div class="bg-white/10 backdrop-blur-sm p-6 rounded-lg border border-white/20">
                      ...
                      <p class="text-white/90">Specialized processing for nutraceutical businesses</p>
                    </div>
                  </div>
                </div>
                ...
                <div class="space-y-8">
                  <div class="bg-white rounded-xl p-8 shadow-xl transform transition hover:shadow-2xl duration-500 border-l-4 border-custom-red">
                    ...
                    <p class="text-gray-700 leading-relaxed">
                      If you're looking for a nutraceutical merchant account, chances are good that you'll need to work with a high-risk account provider to accept credit cards. That's because merchant account providers consider the dietary supplements and nutraceutical industry high-risk.
                    </p>
                  </div>
                  ...
                  <div class="bg-gradient-to-r from-gray-900 to-gray-800 rounded-xl p-8 shadow-xl text-white relative overflow-hidden">
                    ...
                    <div class="relative z-10">
                      ...
                      <p class="text-gray-300 leading-relaxed mb-6">
                        The government regulates the Nutraceutical industry. Every claim a nutraceutical business makes must be supported by clinical trials. A Nutraceutical merchant account provider needs to ensure compliance before working with a Nutraceutical merchant.
                      </p>
                      ...
                      <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mt-8">
                        ...
                        <div class="bg-white/10 backdrop-blur-sm p-4 rounded-lg border border-white/20 flex items-center">
                          ...
                          <span>High Chargeback Ratio</span>
                        </div>
                        ...
                        <div class="bg-white/10 backdrop-blur-sm p-4 rounded-lg border border-white/20 flex items-center">
                          ...
                          <span>Subscription-Based Sales</span>
                        </div>
                      </div>
            ...
            <div class="bg-white rounded-2xl border-2 border-red-100 p-10">
              ...
              <div class="grid grid-cols-1 md:grid-cols-3 gap-10">
                ...
                <div>
                  ...
                  <h3 class="text-xl font-bold mb-4 text-center">Nutraceuticals Merchant Accounts</h3>
                  <ul class="ml-5 space-y-2">
                    ...
                    <li class="flex items-start">
                      <span class="text-custom-red mr-2">•</span>
                      <span class="text-gray-700">Fast Nutraceuticals Account Approval</span>
                    </li>
                    <li class="flex items-start">
                      <span class="text-custom-red mr-2">•</span>
                    ...
                    <li class="flex items-start">
                      <span class="text-custom-red mr-2">•</span>
                      <span class="text-gray-700">E-Commerce and Retail Nutraceuticals</span>
                    </li>
                    <li class="flex items-start">
                      <span class="text-custom-red mr-2">•</span>
                      <span class="text-gray-700">B2B Nutraceuticals Vendors Supported</span>
                    </li>
                  </ul>
                </div>
      ...
      <div id="payment-gateway" class="bg-gradient-to-r from-gray-50 to-red-50 py-16">
        <div class="max-w-7xl mx-auto px-4">
          <h2 class="text-4xl font-bold text-center mb-10" style="color: #973131;">Seamless Payment Processing for Nutraceutical Businesses</h2>
            ...
            <div class="flex flex-col md:flex-row items-start gap-12">
              <div class="md:w-1/2 relative z-10 self-center">
                <p class="text-lg text-gray-700 leading-relaxed">
                  Our nutraceutical merchant accounts are designed to provide smooth, reliable payment processing for your business. With our tailored solutions, you can focus on growing your nutraceutical platform while we handle the complexities of payment processing.
                </p>
                
                <div class="mt-8 p-6 bg-gradient-to-r from-gray-900 to-gray-800 rounded-lg shadow-lg text-white relative overflow-hidden">
                  <div class="relative z-10">
                    <h3 class="text-2xl font-bold mb-4 text-white">Choosing the Best Nutraceutical Payment Processor for Your Business</h3>
                    <p class="text-gray-300 leading-relaxed">
                      Securing the right nutraceutical payment processor is crucial for businesses in the nutraceutical industry to avoid account closures and fund holds. Learn how Hurricane Payments can provide the stable, high-risk processing merchant account your business needs for uninterrupted sales and growth.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div class="md:w-1/2">
                <div class="relative">
                  ...
                  <div class="rounded-lg overflow-hidden shadow-lg relative z-20">
                    <img :src="secondImage" alt="Nutraceutical Payment Gateway" class="w-full h-auto transform transition hover:scale-105 duration-500">
      ...
      <!-- CTA Section -->
      <CtaSection subheading="Apply for your nutraceutical merchant account today and experience hassle-free payment processing." />
    </MainLayout>
  </template>
  ...
  // Import images 
  import firstImage from '@/../images/nutraceuticals.jpg';
  import secondImage from '@/../images/nutraceuticals(2).jpg';
  import thirdImage from '@/../images/nutraceuticals(3).jpg';
