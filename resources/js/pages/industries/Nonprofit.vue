<template>
    <MainLayout>
      ...
      <div class="container mx-auto px-6 py-16 flex flex-col lg:flex-row items-center">
        ...
        <div class="lg:w-1/2 lg:pr-12 mb-10 lg:mb-0 slide-in-left">
          <div class="text-reveal mb-6">
            <h1 class="text-reveal-content text-5xl lg:text-6xl font-bold leading-tight delay-200"
                style="color: #973131;">
              Set Up a Nonprofit Merchant Account
            </h1>
          </div>
          ...
          <div class="text-reveal mb-8">
            <h2 class="text-reveal-content text-2xl lg:text-3xl font-semibold leading-tight delay-200 text-gray-800">
              Specialized Payment Processing for Nonprofit Organizations
            </h2>
          </div>
          
          <div class="text-reveal mb-8">
            <p class="text-reveal-content text-lg text-gray-600 delay-300">
              In today's digital world, nonprofit organizations need reliable payment processing solutions to accept donations and manage fundraising efforts effectively. However, the unique nature of nonprofit transactions can make securing a merchant account challenging. At Hurricane Payments, we provide specialized merchant account solutions designed specifically for nonprofits and charitable organizations, ensuring secure and efficient processing of donations, membership dues, and fundraising payments.
            </p>
        ...
        <div class="lg:w-1/2 relative card-reveal delay-200">
          <div class="rounded-lg shadow-2xl overflow-hidden">
            <img :src="firstImage" alt="Nonprofit Payment Processing" class="w-full h-[800px] object-cover" />
          </div>
      ...
      <!-- Nonprofit Merchant Accounts Section -->
      <div class="container mx-auto px-6 py-20 mt-8">
        ...
        <div class="text-center mb-16 scroll-reveal opacity-0">
          <span class="inline-block text-indigo-600 font-semibold mb-4 tracking-wider text-sm uppercase scroll-reveal opacity-0" style="animation-delay: 0.2s; color: #973131;">
            Get Started with Nonprofit Payment Processing
          </span>
          <h2 class="text-4xl lg:text-5xl font-bold mb-6 scroll-reveal opacity-0" style="animation-delay: 0.4s;">
            Set Up Your Nonprofit Merchant Account in Four Easy Steps
          </h2>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div class="bg-white rounded-lg p-8 text-center shadow-lg scroll-reveal opacity-0 stats-card" data-delay="0">
            ...
            <p class="text-gray-700">
              Start with our streamlined application process designed for nonprofit organizations.
            </p>
          </div>
          ...
          <div class="bg-white rounded-lg p-8 text-center shadow-lg scroll-reveal opacity-0 stats-card" data-delay="200">
            ...
            <p class="text-gray-700">
              Provide required documentation including 501(c)(3) status and organizational papers.
            </p>
          </div>
          ...
          <div class="bg-white rounded-lg p-8 text-center shadow-lg scroll-reveal opacity-0 stats-card" data-delay="400">
            ...
            <p class="text-gray-700">
              Our specialized team will guide you through the setup process ensuring nonprofit compliance.
            </p>
          </div>
          ...
          <div class="bg-white rounded-lg p-8 text-center shadow-lg scroll-reveal opacity-0 stats-card" data-delay="600">
            ...
            <h3 class="text-xl font-bold mb-3 text-gray-800">Start Accepting Donations</h3>
            <p class="text-gray-700">
              Begin processing donations and payments securely through multiple channels.
            </p>
          </div>
        </div>
      </div>
          ...
          <div class="max-w-7xl mx-auto">
            ...
            <div class="text-center mb-16">
              ...
              <h2 class="text-4xl lg:text-5xl font-bold mb-6" style="color: #973131;">
                Understanding Nonprofit Payment Processing Needs
              </h2>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
              ...
              <div class="relative order-2 lg:order-1">
                <div class="relative z-10 rounded-xl overflow-hidden shadow-2xl transition duration-500 transform hover:scale-[1.02]">
                  <img :src="thirdImage" alt="Nonprofit Payment Processing" class="w-full h-[800px] object-cover" />
                  <div class="absolute inset-0 bg-gradient-to-t from-gray-900/70 to-transparent"></div>
                  <div class="absolute bottom-0 left-0 w-full p-8">
                    <div class="bg-white/10 backdrop-blur-sm p-6 rounded-lg border border-white/20">
                      <h3 class="text-xl font-bold mb-2 text-white">Expert Solutions for Nonprofit Organizations</h3>
                      <p class="text-white/90">Specialized processing for nonprofit organizations</p>
                    </div>
                  </div>
                </div>
              ...
              <div class="order-1 lg:order-2">
                <div class="space-y-8">
                  <div class="bg-white rounded-xl p-8 shadow-xl transform transition hover:shadow-2xl duration-500 border-l-4 border-custom-red">
                    <h3 class="text-2xl font-bold mb-4" style="color: #973131;">Nonprofit organizations require specialized payment processors</h3>
                    <p class="text-gray-700 leading-relaxed">
                      Avoid disruptions with Hurricane Payments, a leader in high-risk merchant account solutions for the nonprofit industry.
                    </p>
                  </div>
                  ...
                  <div class="bg-gradient-to-r from-gray-900 to-gray-800 rounded-xl p-8 shadow-xl text-white relative overflow-hidden">
                    ...
                    <div class="relative z-10">
                      <h3 class="text-2xl font-bold mb-4 text-white">Choosing the Right Nonprofit Payment Processor</h3>
                      <p class="text-gray-300 leading-relaxed mb-6">
                        Select a payment processor that understands the nonprofit industry to prevent account closures and fund holds. Trust Hurricane Payments for stability and growth.
                      </p>
            ...
            <div class="bg-white rounded-2xl border-2 border-red-100 p-10">
              ...
              <div class="grid grid-cols-1 md:grid-cols-3 gap-10">
                ...
                <div>
                  ...
                  <h3 class="text-xl font-bold mb-4 text-center">Nonprofit Merchant Accounts</h3>
                  <ul class="ml-5 space-y-2">
                    ...
                    <li class="flex items-start">
                      <span class="text-custom-red mr-2">•</span>
                      <span class="text-gray-700">Fast Nonprofit Account Approval</span>
                    </li>
                    <li class="flex items-start">
                      <span class="text-custom-red mr-2">•</span>
                    ...
                    <li class="flex items-start">
                      <span class="text-custom-red mr-2">•</span>
                      <span class="text-gray-700">E-Commerce and Retail Nonprofit</span>
                    </li>
                    <li class="flex items-start">
                      <span class="text-custom-red mr-2">•</span>
                      <span class="text-gray-700">B2B Nonprofit Vendors Supported</span>
                    </li>
                  </ul>
                </div>
      ...
      <div id="payment-gateway" class="bg-gradient-to-r from-gray-50 to-red-50 py-16">
        <div class="max-w-7xl mx-auto px-4">
          <h2 class="text-4xl font-bold text-center mb-10" style="color: #973131;">Comprehensive Donation Processing Solutions</h2>
            ...
            <div class="flex flex-col md:flex-row items-start gap-12">
              <div class="md:w-1/2 relative z-10 self-center">
                <p class="text-lg text-gray-700 leading-relaxed">
                  Nonprofit organizations require specialized payment processing solutions that can handle various types of donations and payment methods while maintaining compliance with charitable organization regulations. You need a merchant services provider who understands these unique requirements and can provide comprehensive solutions including donation processing and secure payment gateways.
                </p>
                
                <div class="mt-8 p-6 bg-gradient-to-r from-gray-900 to-gray-800 rounded-lg shadow-lg text-white relative overflow-hidden">
                  <div class="relative z-10">
                    <h3 class="text-2xl font-bold mb-4 text-white">Complete Payment Processing for Nonprofits</h3>
                    <p class="text-gray-300 leading-relaxed">
                      Our nonprofit merchant accounts support multiple donation methods, recurring giving programs, and robust reporting features. Focus on your mission while we handle the complexities of payment processing with our secure, efficient solutions.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div class="md:w-1/2">
                <div class="relative">
                  ...
                  <div class="rounded-lg overflow-hidden shadow-lg relative z-20">
                    <img :src="fourthImage" alt="Nonprofit Payment Processing" class="w-full h-auto transform transition hover:scale-105 duration-500">
      ...
      <!-- CTA Section -->
      <CtaSection subheading="Apply for your nonprofit merchant account today and experience hassle-free donation processing." />
    </MainLayout>
  </template>
  ...
  // Import images 
  import firstImage from '@/../images/nonprofit.jpg';
  import secondImage from '@/../images/nonprofit(2).jpg';
  import thirdImage from '@/../images/nonprofit(3).jpg';
  import fourthImage from '@/../images/nonprofit(4).jpg';
