<template>
    ...
    <div class="rounded-lg shadow-2xl overflow-hidden">
      <img :src="firstImage" alt="Travel Payment Processing" class="w-full h-[800px] object-cover" />
    </div>
      ...
      <!-- Travel Merchant Accounts Section -->
      <div class="container mx-auto px-6 py-20 mt-8">
        ...
        <div class="text-center mb-16 scroll-reveal opacity-0">
          ...
          <h2 class="text-4xl lg:text-5xl font-bold mb-6 scroll-reveal opacity-0" style="animation-delay: 0.4s;">
            Set Up Your Travel Merchant Account in Four Easy Steps
          </h2>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div class="bg-white rounded-lg p-8 text-center shadow-lg scroll-reveal opacity-0 stats-card" data-delay="0">
            ...
            <p class="text-gray-700">
              Begin with our straightforward online application tailored for travel businesses and agencies.
            </p>
          </div>
          ...
          <div class="bg-white rounded-lg p-8 text-center shadow-lg scroll-reveal opacity-0 stats-card" data-delay="200">
            ...
            <p class="text-gray-700">
              Provide essential documents to support your travel merchant account application.
            </p>
          </div>
          ...
          <div class="bg-white rounded-lg p-8 text-center shadow-lg scroll-reveal opacity-0 stats-card" data-delay="400">
            ...
            <p class="text-gray-700">
              Our experts guide you through the underwriting process specific to travel industry businesses.
            </p>
          </div>
          ...
          <div class="bg-white rounded-lg p-8 text-center shadow-lg scroll-reveal opacity-0 stats-card" data-delay="600">
            ...
            <p class="text-gray-700">
              Begin accepting payments for travel services, vacation packages, and tour bookings with Hurricane Payments' payment processing. This will enable you to grow your revenue and enhance customer satisfaction.
            </p>
          </div>
        </div>
      </div>
      ...
      <div class="py-24 bg-gradient-to-b from-gray-50 to-white relative overflow-hidden">
          ...
          <div class="max-w-7xl mx-auto">
            ...
            <div class="text-center mb-16">
              ...
              <h2 class="text-4xl lg:text-5xl font-bold mb-6" style="color: #973131;">
                Why is a Travel Merchant Account Labeled High-Risk?
              </h2>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
              ...
              <div class="relative order-2 lg:order-1">
                <div class="relative z-10 rounded-xl overflow-hidden shadow-2xl transition duration-500 transform hover:scale-[1.02]">
                  <img :src="thirdImage" alt="Travel High-Risk Merchant Services" class="w-full h-[800px] object-cover" />
                  <div class="absolute inset-0 bg-gradient-to-t from-gray-900/70 to-transparent"></div>
                  <div class="absolute bottom-0 left-0 w-full p-8">
                    <div class="bg-white/10 backdrop-blur-sm p-6 rounded-lg border border-white/20">
                      <h3 class="text-xl font-bold mb-2 text-white">Expert Solutions for High-Risk Travel Merchants</h3>
                      <p class="text-white/90">Specialized processing for travel agencies and tour operators</p>
                    </div>
                  </div>
                </div>
                ...
                <div class="space-y-8">
                  ...
                  <div class="bg-gradient-to-r from-gray-900 to-gray-800 rounded-xl p-8 shadow-xl text-white relative overflow-hidden">
                    ...
                    <div class="relative z-10">
                      <h3 class="text-2xl font-bold mb-4 text-white">Key Factors Leading to High-Risk Classification</h3>
                      <p class="text-gray-300 leading-relaxed mb-6">
                        Travel businesses are labeled high-risk due to specific factors that concern payment processors:
                      </p>
                      ...
                      <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mt-8">
                        <div class="bg-white/10 backdrop-blur-sm p-4 rounded-lg border border-white/20 flex items-center">
                          ...
                          <span>High Fraud Risk (Card-Not-Present)</span>
                        </div>
                        ...
                        <div class="bg-white/10 backdrop-blur-sm p-4 rounded-lg border border-white/20 flex items-center">
                          ...
                          <span>Prolonged Delivery Times</span>
                        </div>
                        ...
                        <div class="bg-white/10 backdrop-blur-sm p-4 rounded-lg border border-white/20 flex items-center">
                          ...
                          <span>High Chargeback Risk</span>
                        </div>
        ...
        <!-- Travel Guidelines Section with Page Break -->
        <div id="content-guidelines" class="py-16">
          <div class="max-w-5xl mx-auto px-6 mb-12">
            ...
            <h2 class="text-4xl font-bold text-center mb-10" style="color: #973131;">Travel Industry Guidelines</h2>
              ...
              <div class="bg-green-50 p-8 rounded-xl relative overflow-hidden">
                ...
                <ul class="space-y-3 relative z-10">
                  <li class="flex items-start">
                    ...
                    <span class="text-gray-700">Transparent cancellation policies and refund terms</span>
                  </li>
                  <li class="flex items-start">
                    <span class="text-green-600 mr-2">✓</span>
                    <span class="text-gray-700">Detailed service descriptions and itineraries</span>
                  </li>
                  <li class="flex items-start">
                    <span class="text-green-600 mr-2">✓</span>
                    <span class="text-gray-700">Secure customer data handling practices</span>
                  </li>
                  <li class="flex items-start">
                    <span class="text-green-600 mr-2">✓</span>
                    <span class="text-gray-700">Clear communication about travel restrictions</span>
                  </li>
                  <li class="flex items-start">
                    <span class="text-green-600 mr-2">✓</span>
                    <span class="text-gray-700">Documented confirmation of bookings</span>
                  </li>
                </ul>
              </div>
              ...
              <div class="bg-red-50 p-8 rounded-xl relative overflow-hidden">
                ...
                <ul class="space-y-3 relative z-10">
                  <li class="flex items-start">
                    ...
                    <span class="text-gray-700">Unclear cancellation and refund policies</span>
                  </li>
                  <li class="flex items-start">
                    <span class="text-red-600 mr-2">✗</span>
                    <span class="text-gray-700">Vague service descriptions or terms</span>
                  </li>
                  <li class="flex items-start">
                    <span class="text-red-600 mr-2">✗</span>
                    <span class="text-gray-700">Poor customer communication</span>
                  </li>
                  <li class="flex items-start">
                    <span class="text-red-600 mr-2">✗</span>
                  ...
                  <li class="flex items-start">
                    <span class="text-red-600 mr-2">✗</span>
                    <span class="text-gray-700">Misrepresentation of travel services</span>
                  </li>
                </ul>
              </div>
            </div>
            ...
            <p class="text-center text-gray-700 mt-8">
              Following these guidelines helps ensure compliance with industry standards and creates a trustworthy environment for your travel customers.
            </p>
          </div>
        </div>
  
  
      <!-- Travel Industry Challenges Section -->
      <div id="travel-challenges" class="py-16 bg-white">
        <div class="max-w-7xl mx-auto px-4">
          <div class="text-center mb-16">
            ...
            <h2 class="text-4xl lg:text-5xl font-bold mb-8" style="color: #973131;">
              Travel Business Payment Solutions
            </h2>
            <div class="w-24 h-1 bg-custom-red mx-auto rounded-full mb-8"></div>
          </div>
          ...
          <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <img :src="secondImage" alt="Travel Industry Solutions" class="rounded-lg shadow-xl w-full">
            </div>
            
            <div>
              <h3 class="text-2xl font-bold mb-6" style="color: #973131;">Understanding Travel Industry Payment Challenges</h3>
              
              <p class="text-gray-700 mb-6">
                The travel industry faces unique payment processing challenges due to its business model. Most travel services have a prolonged delivery time - tour operators and travel agencies sell reservations for services that often won't be delivered for months. This creates several critical payment processing issues:
              </p>
              
              <div class="space-y-4 mb-8">
                <div class="bg-red-50 p-4 rounded-lg">
                  <h4 class="font-bold text-red-800 mb-2">High Chargeback Risk</h4>
                  <p class="text-gray-700">The long timeframe between purchase and service delivery creates a higher risk of customer disputes and chargebacks, especially if travel plans change.</p>
                </div>
                
                <div class="bg-blue-50 p-4 rounded-lg">
                  <h4 class="font-bold text-blue-800 mb-2">Fraud Vulnerability</h4>
                  <p class="text-gray-700">With mostly card-not-present transactions, travel businesses are more susceptible to fraudulent purchases and identity theft.</p>
                </div>
                
                <div class="bg-green-50 p-4 rounded-lg">
                  <h4 class="font-bold text-green-800 mb-2">High-Ticket Transactions</h4>
                  <p class="text-gray-700">Travel services often involve large transaction amounts, which can increase the impact of chargebacks and fraud on your business.</p>
                </div>
              </div>
              
              <div class="bg-gray-900 p-6 rounded-lg text-white">
                <h3 class="text-xl font-bold mb-4">Hurricane Payments' Travel Industry Solutions</h3>
                <ul class="space-y-2">
                  <li class="flex items-start">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-green-400 mr-2 flex-shrink-0 mt-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7" />
                    </svg>
                    <span>Specialized chargeback prevention tools to protect your business</span>
                  </li>
                  <li class="flex items-start">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-green-400 mr-2 flex-shrink-0 mt-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7" />
                    </svg>
                    <span>Advanced fraud detection systems designed for travel transactions</span>
                  </li>
                  <li class="flex items-start">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-green-400 mr-2 flex-shrink-0 mt-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7" />
                    </svg>
                    <span>Multiple payment gateway options to ensure transaction security</span>
                  </li>
                  <li class="flex items-start">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-green-400 mr-2 flex-shrink-0 mt-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7" />
                    </svg>
                    <span>Dedicated account managers who understand the travel industry</span>
                  </li>
                </ul>
              </div>
            </div>
      ...
      <!-- Travel Payment Gateway Section -->
      <div id="payment-gateway" class="bg-gradient-to-r from-gray-50 to-red-50 py-16">
        <div class="max-w-7xl mx-auto px-4">
          <h2 class="text-4xl font-bold text-center mb-10" style="color: #973131;">Seamless Payment Processing for Travel Businesses</h2>
            ...
            <div class="flex flex-col md:flex-row items-start gap-12">
              <div class="md:w-1/2 relative z-10 self-center">
                <p class="text-lg text-gray-700 leading-relaxed">
                  Our travel merchant accounts are designed for smooth, reliable payment processing. Focus on expanding your travel business while we handle the complexities of high-risk payment solutions.
                </p>
                ...
                <div class="mt-8 p-6 bg-gradient-to-r from-gray-900 to-gray-800 rounded-lg shadow-lg text-white relative overflow-hidden">
                  ...
                  <div class="relative z-10">
                    <h3 class="text-2xl font-bold mb-4 text-white">Reliable Payment Processing Solutions for Travel Businesses</h3>
                    <p class="text-gray-300 leading-relaxed">
                      Our travel merchant accounts offer smooth, dependable payment processing tailored to your business needs. With Hurricane Payments' specialized solutions, you can concentrate on expanding your travel agency, tour operation, or booking platform while we manage the intricacies of secure and compliant payment processing.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div class="md:w-1/2">
                <div class="relative">
                  ...
                  <div class="rounded-lg overflow-hidden shadow-lg relative z-20">
                    <img :src="fourthImage" alt="Travel Payment Gateway" class="w-full h-auto transform transition hover:scale-105 duration-500">
      ...
      <!-- CTA Section -->
      <CtaSection subheading="Apply for your Travel industry merchant account today and experience hassle-free payment processing." />
    </MainLayout>
  </template>
  ...
  // Import images 
  import firstImage from '@/../images/travel.jpg';
  import secondImage from '@/../images/travel(2).jpg';
  import thirdImage from '@/../images/travel(3).jpg';
  import fourthImage from '@/../images/travel(4).jpg';
