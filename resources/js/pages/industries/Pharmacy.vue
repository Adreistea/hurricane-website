<template>
        ...
        <div class="lg:w-1/2 lg:pr-12 mb-10 lg:mb-0 slide-in-left">
          ...
          <div class="text-reveal mb-8">
            <h2 class="text-reveal-content text-2xl lg:text-3xl font-semibold leading-tight delay-200 text-gray-800">
              Pharmacy Merchant Account: Essential Payment Solutions for Modern Pharmacies
            </h2>
          </div>
          
          <div class="text-reveal mb-8">
            <p class="text-reveal-content text-lg text-gray-600 delay-300">
              Operating a pharmacy requires a specialized merchant account that understands the unique challenges of processing healthcare-related payments. Whether you run an independent pharmacy, an online pharmacy, or a chain of locations, secure and compliant payment processing is essential.
            </p>
            ...
            <ul class="mt-4 space-y-2">
              <li class="flex items-start fade-in-slide-up" style="animation-delay: 100ms;">
                ...
                <span class="ml-3 text-gray-700">HIPAA-Compliant Processing</span>
              </li>
              <li class="flex items-start fade-in-slide-up" style="animation-delay: 200ms;">
                ...
                <span class="ml-3 text-gray-700">Healthcare Payment Expertise</span>
              </li>
              <li class="flex items-start fade-in-slide-up" style="animation-delay: 300ms;">
                ...
                <span class="ml-3 text-gray-700">FSA/HSA Card Acceptance</span>
              </li>
              <li class="flex items-start fade-in-slide-up" style="animation-delay: 400ms;">
                ...
                <span class="ml-3 text-gray-700">Insurance Payment Processing</span>
              </li>
              ...
              <li class="flex items-start fade-in-slide-up" style="animation-delay: 600ms;">
                ...
                <span class="ml-3 text-gray-700">Comprehensive Reporting Tools</span>
              </li>
            </ul>
          </div>
    ...
    <div class="rounded-lg shadow-2xl overflow-hidden">
      <img :src="firstImage" alt="Pharmacy Payment Processing" class="w-full h-[800px] object-cover" />
    </div>
      ...
      <div class="container mx-auto px-6 py-20 mt-8">
        ...
        <div class="text-center mb-16 scroll-reveal opacity-0">
          <span class="inline-block text-indigo-600 font-semibold mb-4 tracking-wider text-sm uppercase scroll-reveal opacity-0" style="animation-delay: 0.2s; color: #973131;">
            Get Started with Pharmacy Payment Processing
          </span>
          <h2 class="text-4xl lg:text-5xl font-bold mb-6 scroll-reveal opacity-0" style="animation-delay: 0.4s;">
            Set Up Your Pharmacy Merchant Account in Four Easy Steps
          </h2>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div class="bg-white rounded-lg p-8 text-center shadow-lg scroll-reveal opacity-0 stats-card" data-delay="0">
            ...
            <p class="text-gray-700">
              Start with our streamlined application process designed for pharmacy businesses.
            </p>
          </div>
          ...
          <div class="bg-white rounded-lg p-8 text-center shadow-lg scroll-reveal opacity-0 stats-card" data-delay="200">
            ...
            <p class="text-gray-700">
              Provide required documentation including pharmacy licenses and compliance certificates.
            </p>
          </div>
          ...
          <div class="bg-white rounded-lg p-8 text-center shadow-lg scroll-reveal opacity-0 stats-card" data-delay="400">
            ...
            <p class="text-gray-700">
              Our specialized team will guide you through the setup process ensuring regulatory compliance.
            </p>
          </div>
          ...
          <div class="bg-white rounded-lg p-8 text-center shadow-lg scroll-reveal opacity-0 stats-card" data-delay="600">
            ...
            <p class="text-gray-700">
              Begin accepting payments securely while maintaining healthcare compliance standards.
            </p>
          </div>
        </div>
      </div>
          ...
          <div class="max-w-7xl mx-auto">
            ...
            <div class="text-center mb-16">
              ...
              <h2 class="text-4xl lg:text-5xl font-bold mb-6" style="color: #973131;">
                Understanding High-Risk Designation for Pharmacy Merchant Accounts
              </h2>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
              <div class="relative order-2 lg:order-1">
                <div class="relative z-10 rounded-xl overflow-hidden shadow-2xl transition duration-500 transform hover:scale-[1.02]">
                  <img :src="thirdImage" alt="Pharmacy High-Risk Merchant Services" class="w-full h-[800px] object-cover" />
                  <div class="absolute inset-0 bg-gradient-to-t from-gray-900/70 to-transparent"></div>
                  <div class="absolute bottom-0 left-0 w-full p-8">
                    <div class="bg-white/10 backdrop-blur-sm p-6 rounded-lg border border-white/20">
                      <h3 class="text-xl font-bold mb-2 text-white">Expert Solutions for Pharmacies</h3>
                      <p class="text-white/90">Specialized processing for healthcare payments</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="order-1 lg:order-2">
                <div class="space-y-8">
                  <div class="bg-white rounded-xl p-8 shadow-xl transform transition hover:shadow-2xl duration-500 border-l-4 border-custom-red">
                    <h3 class="text-2xl font-bold mb-4" style="color: #973131;">Why Pharmacies Need Specialized Payment Processing</h3>
                    <p class="text-gray-700 leading-relaxed">
                      Pharmacy businesses face unique challenges in payment processing due to regulatory requirements and the sensitive nature of healthcare transactions.
                    </p>
                  </div>
                  
                  <div class="bg-gradient-to-r from-gray-900 to-gray-800 rounded-xl p-8 shadow-xl text-white relative overflow-hidden">
                    <div class="relative z-10">
                      <h3 class="text-2xl font-bold mb-4 text-white">High-Risk Factors in Pharmacy Payment Processing</h3>
                      <p class="text-gray-300 leading-relaxed mb-6">
                        Pharmacy businesses face several factors that lead payment processors to classify them as high-risk merchants, including regulatory compliance, high-value transactions, and healthcare sensitivity.
                      </p>
                      ...
                      <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mt-8">
                        ...
                        <div class="bg-white/10 backdrop-blur-sm p-4 rounded-lg border border-white/20 flex items-center">
                          ...
                          <span>Insurance Processing</span>
                        </div>
            ...
            <div class="bg-white rounded-2xl border-2 border-red-100 p-10">
              ...
              <div class="grid grid-cols-1 md:grid-cols-3 gap-10">
                ...
                <div>
                  ...
                  <h3 class="text-xl font-bold mb-4 text-center">Pharmacy Merchant Accounts</h3>
                  <ul class="ml-5 space-y-2">
                    ...
                    <li class="flex items-start">
                      <span class="text-custom-red mr-2">•</span>
                      <span class="text-gray-700">HIPAA-Compliant Processing</span>
                    </li>
                    <li class="flex items-start">
                      <span class="text-custom-red mr-2">•</span>
                      <span class="text-gray-700">Fast Pharmacy Account Approval</span>
                    </li>
                    <li class="flex items-start">
                      <span class="text-custom-red mr-2">•</span>
                      <span class="text-gray-700">Healthcare Payment Solutions</span>
                    </li>
                    <li class="flex items-start">
                      <span class="text-custom-red mr-2">•</span>
                      <span class="text-gray-700">E-Commerce and Retail Pharmacy</span>
                    </li>
                    <li class="flex items-start">
                      <span class="text-custom-red mr-2">•</span>
                      <span class="text-gray-700">B2B Pharmacy Vendors Supported</span>
                    </li>
                  </ul>
                </div>
                ...
                <div>
                  ...
                  <ul class="ml-10 space-y-2">
                    <li class="flex items-start">
                      <span class="text-custom-red mr-2">•</span>
                      <span class="text-gray-700">FSA/HSA Card Processing</span>
                    </li>
                    <li class="flex items-start">
                      <span class="text-custom-red mr-2">•</span>
                      <span class="text-gray-700">Insurance Payment Processing</span>
                    </li>
                    <li class="flex items-start">
                      <span class="text-custom-red mr-2">•</span>
                    ...
                    <li class="flex items-start">
                      <span class="text-custom-red mr-2">•</span>
                      <span class="text-gray-700">Mobile Payments</span>
                    </li>
                    <li class="flex items-start">
                      <span class="text-custom-red mr-2">•</span>
                      <span class="text-gray-700">EMV-Compliant Solutions</span>
                    </li>
                  </ul>
                </div>
                ...
                <div>
                  ...
                  <h3 class="text-xl font-bold mb-4 text-center">Healthcare Compliance</h3>
                  <ul class="ml-15 space-y-2">
                    <li class="flex items-start">
                      <span class="text-custom-red mr-2">•</span>
                      <span class="text-gray-700">HIPAA Compliance</span>
                    </li>
                    <li class="flex items-start">
                      <span class="text-custom-red mr-2">•</span>
                    ...
                    <li class="flex items-start">
                      <span class="text-custom-red mr-2">•</span>
                      <span class="text-gray-700">Regulatory Reporting</span>
                    </li>
                    <li class="flex items-start">
                      <span class="text-custom-red mr-2">•</span>
                      <span class="text-gray-700">PCI DSS Compliance</span>
                    </li>
                    <li class="flex items-start">
                      <span class="text-custom-red mr-2">•</span>
      ...
      <!-- Pharmacy Payment Gateway Section -->
      <div id="payment-gateway" class="bg-gradient-to-r from-gray-50 to-red-50 py-16">
        <div class="max-w-7xl mx-auto px-4">
          <h2 class="text-4xl font-bold text-center mb-10" style="color: #973131;">Complete Payment Processing for Pharmacies</h2>
            ...
            <div class="flex flex-col md:flex-row items-start gap-12">
              <div class="md:w-1/2 relative z-10 self-center">
                <p class="text-lg text-gray-700 leading-relaxed">
                  Our pharmacy merchant accounts support multiple payment methods, healthcare-specific cards, and robust reporting features. Focus on serving your patients while we handle the complexities of payment processing with our secure, compliant solutions.
                </p>
                
                <div class="mt-8 p-6 bg-gradient-to-r from-gray-900 to-gray-800 rounded-lg shadow-lg text-white relative overflow-hidden">
                  <div class="relative z-10">
                    <h3 class="text-2xl font-bold mb-4 text-white">Reliable Healthcare Payment Solutions</h3>
                    <p class="text-gray-300 leading-relaxed">
                      Our specialized merchant accounts offer secure, compliant, and efficient payment processing tailored to the unique needs of pharmacies. With Hurricane Payments' solutions, you can focus on patient care while we manage the complexities of payment processing.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div class="md:w-1/2">
                <div class="relative">
                  ...
                  <div class="rounded-lg overflow-hidden shadow-lg relative z-20">
                    <img :src="fourthImage" alt="Pharmacy Payment Gateway" class="w-full h-auto transform transition hover:scale-105 duration-500">
                    <div class="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent"></div>
                    <div class="absolute bottom-0 left-0 p-6">
                      <h3 class="text-xl font-bold text-white mb-2">Secure Healthcare Transactions</h3>
                      <div class="flex items-center">
                        <div class="w-3 h-3 rounded-full bg-green-500 mr-2 animate-pulse"></div>
                        <span class="text-white font-medium">HIPAA & PCI Compliant</span>
                      </div>
                    </div>
                  </div>
                </div>
      ...
      <!-- CTA Section -->
      <CtaSection subheading="Apply for your pharmacy merchant account today and experience hassle-free payment processing." />
    </MainLayout>
  </template>
  ...
  // Import images 
  import firstImage from '@/../images/pharmacy.jpg';
  import secondImage from '@/../images/pharmacy(2).jpg';
  import thirdImage from '@/../images/pharmacy(3).jpg';
  import fourthImage from '@/../images/pharmacy(3).jpg';
