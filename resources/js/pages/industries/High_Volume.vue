<template>
    <MainLayout>
      ...
      <div class="container mx-auto px-6 py-16 flex flex-col lg:flex-row items-center">
        ...
        <div class="lg:w-1/2 lg:pr-12 mb-10 lg:mb-0 slide-in-left">
          ...
          <div class="text-reveal mb-8">
            <h2 class="text-reveal-content text-2xl lg:text-3xl font-semibold leading-tight delay-200 text-gray-800">
              Need a payment processor that can handle your high transaction volume?
            </h2>
          </div>
          
          <div class="text-reveal mb-8">
            <p class="text-reveal-content text-lg text-gray-600 delay-300">
              A high-volume merchant account is essential for businesses processing large numbers of transactions or substantial monthly volumes. These specialized payment processing accounts are designed to handle significant transaction volumes while providing competitive rates and robust security measures. At Hurricane Payments, we specialize in providing merchant accounts tailored to high-volume businesses, ensuring seamless processing for your large transaction volumes.
            </p>
        ...
        <div class="lg:w-1/2 relative card-reveal delay-200">
          <div class="rounded-lg shadow-2xl overflow-hidden">
            <img :src="firstImage" alt="High Volume Payment Processing" class="w-full h-[800px] object-cover" />
          </div>
      ...
      <!-- High Volume Merchant Accounts Section -->
      <div class="container mx-auto px-6 py-20 mt-8">
        ...
        <div class="text-center mb-16 scroll-reveal opacity-0">
          ...
          <h2 class="text-4xl lg:text-5xl font-bold mb-6 scroll-reveal opacity-0" style="animation-delay: 0.4s;">
            Get Started with High Volume Payment Processing
          </h2>
          <p class="text-lg text-gray-600 max-w-3xl mx-auto scroll-reveal opacity-0" style="animation-delay: 0.6s;">
            Follow these simple steps to set up your high-volume merchant account
          </p>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div class="bg-white rounded-lg p-8 text-center shadow-lg scroll-reveal opacity-0 stats-card" data-delay="0">
            ...
            <h3 class="text-xl font-bold mb-3 text-gray-800">Complete our streamlined application</h3>
            <p class="text-gray-700">
              Start with our efficient online application process designed for high-volume businesses.
            </p>
          </div>
          ...
          <div class="bg-white rounded-lg p-8 text-center shadow-lg scroll-reveal opacity-0 stats-card" data-delay="200">
            ...
            <h3 class="text-xl font-bold mb-3 text-gray-800">Provide processing history</h3>
            <p class="text-gray-700">
              Share your transaction history to help us customize your solution.
            </p>
          </div>
          ...
          <div class="bg-white rounded-lg p-8 text-center shadow-lg scroll-reveal opacity-0 stats-card" data-delay="400">
            ...
            <h3 class="text-xl font-bold mb-3 text-gray-800">Get expert underwriting support</h3>
            <p class="text-gray-700">
              Our specialized team will guide you through the high-volume account approval process.
            </p>
          </div>
          ...
          <div class="bg-white rounded-lg p-8 text-center shadow-lg scroll-reveal opacity-0 stats-card" data-delay="600">
            ...
            <h3 class="text-xl font-bold mb-3 text-gray-800">Begin processing at scale</h3>
            <p class="text-gray-700">
              Start processing high volumes with competitive rates and reliable service.
            </p>
          </div>
        </div>
      </div>
          ...
          <div class="flex flex-col lg:flex-row items-center gap-12">
            <div class="lg:w-1/2 relative order-2 lg:order-1">
              <div class="relative z-10 rounded-xl overflow-hidden shadow-2xl transition duration-500 transform hover:scale-[1.02]">
                <img :src="thirdImage" alt="High Volume Merchant Services" class="w-full h-[800px] object-cover" />
                <div class="absolute inset-0 bg-gradient-to-t from-gray-900/70 to-transparent"></div>
                <div class="absolute bottom-0 left-0 w-full p-8">
                  <div class="bg-white/10 backdrop-blur-sm p-6 rounded-lg border border-white/20">
                    <h3 class="text-xl font-bold mb-2 text-white">Expert Solutions for High-Volume Merchants</h3>
                    <p class="text-white/90">Specialized processing for businesses with large transaction volumes</p>
                  </div>
                </div>
              </div>
            ...
            <div class="lg:w-1/2 order-1 lg:order-2">
              <div class="space-y-8">
                <div class="bg-white rounded-xl p-8 shadow-xl transform transition hover:shadow-2xl duration-500 border-l-4 border-custom-red">
                  <h3 class="text-2xl font-bold mb-4" style="color: #973131;">High-volume businesses require specialized payment processors</h3>
                  <p class="text-gray-700 leading-relaxed">
                    Traditional payment processors often impose transaction limits or charge excessive fees for large volumes. If you're processing significant monthly volumes or high numbers of transactions, you need a specialized high-volume merchant account.
                  </p>
                </div>
                
                <div class="bg-gradient-to-r from-gray-900 to-gray-800 rounded-xl p-8 shadow-xl text-white relative overflow-hidden">
                  <div class="relative z-10">
                    <h3 class="text-2xl font-bold mb-4 text-white">Understanding High Volume Processing Requirements</h3>
                    <p class="text-gray-300 leading-relaxed mb-6">
                      High-volume merchants often face challenges with traditional payment processors due to their substantial transaction volumes and processing requirements. Successfully processing high volumes requires partnering with a payment processor experienced in handling large transaction volumes.
                    </p>
          ...
          <div class="bg-white rounded-2xl border-2 border-red-100 p-10">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-10">
              ...
              <div>
                ...
                <h3 class="text-xl font-bold mb-4 text-center">High Volume Merchant Accounts</h3>
                <ul class="ml-5 space-y-2">
                  ...
                  <li class="flex items-start">
                    <span class="text-custom-red mr-2">•</span>
                    <span class="text-gray-700">Fast High Volume Account Approval</span>
                  </li>
                  <li class="flex items-start">
                    <span class="text-custom-red mr-2">•</span>
                  ...
                  <li class="flex items-start">
                    <span class="text-custom-red mr-2">•</span>
                    <span class="text-gray-700">E-Commerce and Retail High Volume</span>
                  </li>
                  <li class="flex items-start">
                    <span class="text-custom-red mr-2">•</span>
                    <span class="text-gray-700">B2B High Volume Vendors Supported</span>
                  </li>
                </ul>
              </div>
      ...
      <!-- High Volume Payment Gateway Section -->
      <div id="payment-gateway" class="bg-gradient-to-r from-gray-50 to-red-50 py-16">
        <div class="max-w-7xl mx-auto px-4">
          <h2 class="text-4xl font-bold text-center mb-10" style="color: #973131;">Scalable Payment Processing for High-Volume Businesses</h2>
            ...
            <div class="flex flex-col md:flex-row items-start gap-12">
              <div class="md:w-1/2 relative z-10 self-center">
                <p class="text-lg text-gray-700 leading-relaxed">
                  Our high-volume merchant accounts are designed to provide reliable, efficient payment processing that scales with your business. With our tailored solutions, you can focus on growing your business while we handle your payment processing needs.
                </p>
                ...
                <div class="mt-8 p-6 bg-gradient-to-r from-gray-900 to-gray-800 rounded-lg shadow-lg text-white relative overflow-hidden">
                  ...
                  <div class="relative z-10">
                    <h3 class="text-2xl font-bold mb-4 text-white">Reliable Payment Processing Solutions for High-Volume Businesses</h3>
                    <p class="text-gray-300 leading-relaxed">
                      Finding the right payment processor is crucial for high-volume businesses to avoid processing interruptions and maintain competitive rates. Choose Hurricane Payments for reliable, scalable processing solutions that grow with your business.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div class="md:w-1/2">
                <div class="relative">
                  ...
                  <div class="rounded-lg overflow-hidden shadow-lg relative z-20">
                    <img :src="fourthImage" alt="High Volume Payment Gateway" class="w-full h-auto transform transition hover:scale-105 duration-500">
                    <div class="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent"></div>
                    <div class="absolute bottom-0 left-0 p-6">
                      <h3 class="text-xl font-bold text-white mb-2">Secure High-Volume Processing</h3>
                  ...
                  <div class="absolute -bottom-10 -right-10 bg-white rounded-lg shadow-xl p-6 z-30 max-w-xs transform rotate-3">
                    ...
                    <ul class="space-y-2">
                      <li class="flex items-center">
                        ...
                        <span class="text-gray-700">High-Volume Support</span>
                      </li>
                      <li class="flex items-center">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-green-500 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                          <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7" />
                      ...
                      <li class="flex items-center">
                        ...
                        <span class="text-gray-700">Volume Discounts</span>
                      </li>
                    </ul>
                  </div>
                </div>
      ...
      <!-- CTA Section -->
      <CtaSection subheading="Apply for your high-volume merchant account today and experience hassle-free payment processing." />
    </MainLayout>
  </template>
  ...
  // Import images 
  import firstImage from '@/../images/highvolume.jpg';
  import secondImage from '@/../images/highvolume(2).jpg';
  import thirdImage from '@/../images/highvolume(3).jpg';
  import fourthImage from '@/../images/highvolume(4).jpg';
