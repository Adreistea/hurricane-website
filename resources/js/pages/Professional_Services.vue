    ...
    <div class="container mx-auto px-6 py-16 flex flex-col lg:flex-row items-center">
      ...
      <div class="lg:w-1/2 lg:pr-12 mb-10 lg:mb-0 slide-in-left">
        <div class="text-reveal mb-2">
          <span class="text-reveal-content text-blue-600 font-semibold delay-100">Industry Solutions</span>
        </div>
        ...
        <div class="text-reveal mb-8">
          <p class="text-reveal-content text-lg text-gray-600 delay-300">
            Streamline your payment processes, enhance client experience, and focus on your expertise with our tailored payment solutions for professional service providers.
          </p>
        </div>
      ...
      <div class="lg:w-1/2 relative card-reveal delay-200">
        <div class="rounded-lg shadow-2xl overflow-hidden">
          <img src="@/../images/TransparentLogo.png" alt="Professional Services Solutions" class="w-full h-auto" />
        </div>
    ...
    <div class="relative py-24 mt-16">
      <div class="container mx-auto px-6">
        <div class="text-center mb-12">
          <h2 class="text-4xl font-bold mb-4" style="color: #973131;">Payment Solutions for Professionals</h2>
          ...
          <div class="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-12">
            ...
            <div class="bg-white p-6 md:p-8 rounded-lg shadow-sm scroll-reveal opacity-0 solution-card" data-delay="0">
              <div class="flex flex-row items-center mb-4">
                ...
                <h2 class="text-2xl font-bold text-blue-500">Virtual Terminal</h2>
              </div>
              <p class="text-gray-700">
                Accept payments remotely over the phone, through email invoices, or during consultations with our secure virtual terminal solution.
              </p>
            </div>
            ...
            <div class="bg-white p-6 md:p-8 rounded-lg shadow-sm scroll-reveal opacity-0 solution-card" data-delay="200">
              <div class="flex flex-row items-center mb-4">
                ...
                <h2 class="text-2xl font-bold text-indigo-500">Recurring Billing</h2>
              </div>
              <p class="text-gray-700">
                Automate invoicing and payment collection for retainer clients with customizable billing cycles and payment terms.
              </p>
            </div>
            ...
            <div class="bg-white p-6 md:p-8 rounded-lg shadow-sm scroll-reveal opacity-0 solution-card" data-delay="400">
              <div class="flex flex-row items-center mb-4">
                ...
                <h2 class="text-2xl font-bold text-purple-500">Mobile Processing</h2>
              </div>
              <p class="text-gray-700">
                Accept payments on-site with clients using your smartphone or tablet, perfect for consultants, accountants, and other professionals who work in multiple locations.
              </p>
            </div>
          </div>
        </div>
